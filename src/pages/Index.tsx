          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 max-w-2xl mx-auto relative">
              ...
              <Input
                ...
                className="pl-12 pr-4 h-12 text-lg border border-border/20 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 focus:ring-2 focus:ring-primary/50 rounded-xl"
              />
            </div>
